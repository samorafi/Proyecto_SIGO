...
export default function OfertasEnLinea() {
    ...
    const [nuevaOferta, setNuevaOferta] = useState({
        cursoId: "",
        sedeId: "",
        modalidadId: 3, // Modalidad en línea
        horarioId: "",
        periodoId: "",
        coordinadorId: "",
        comentarios: "",
    ...
    useEffect(() => {
        const fetchOfertas = async () => {
            try {
                ...
                // Filtro para modalidades en Linea
                const modalidadesFiltrar = [3];
    ...
    const handleNuevaOferta = async () => {
        try {
            if (
                !nuevaOferta.cursoId ||
                !nuevaOferta.sedeId ||
                !nuevaOferta.horarioId ||
                !nuevaOferta.periodoId ||
                !nuevaOferta.coordinadorId
            ) {
            ...
            const response = await fetch("/api/ofertas", {
                ...
                body: JSON.stringify({ ...nuevaOferta, modalidadId: 3 }),
            });
